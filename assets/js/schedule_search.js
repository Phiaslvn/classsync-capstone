        ...
        groupSchedules.forEach(schedule => {
            html += `
                <tr>
                    ...
                    <td><span class="badge bg-dark text-white fw-bold">${escapeHtml(schedule.schd_day)}</span></td>
                    <td>
                        <span class="badge bg-primary text-white fw-bold">${escapeHtml(schedule.start_time)} - ${escapeHtml(schedule.end_time)}</span>
                    </td>
                    <td>
